...
draft: false
date: 12-02-2021
title: "Design for Online and Blended Learning"
description: |
...
categories:
  ...
  - Open education
  - Blended learning
preview: https://imgs.xkcd.com/comics/correlation.png
author:
  - name: Linda Sellou
...
```{r, fig.cap='Correlation (From [xkcd](https://xkcd.com/225/))',preview=TRUE}
knitr::include_graphics('http://imgs.xkcd.com/comics/correlation.png')
```
