...
categories:
  ...
  - Open education
preview: https://knowledgeone.ca/wp-content/uploads/2020/05/4-modes-en.jpg
author:
  - name: Linda Sellou
...
```{r, fig.cap='Modes of Learning Framework from Professor Richard Elmore. Source Knowledge One ([article by **Catherine Meilleur**](https://knowledgeone.ca/elmores-4-learning-modes/))',preview=TRUE}
knitr::include_graphics('https://knowledgeone.ca/wp-content/uploads/2020/05/4-modes-en.jpg')
```
